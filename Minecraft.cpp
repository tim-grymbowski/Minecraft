...
{
private:
	/* The idea is that given the default coordinate system,
	 * imagining the camera in there means imagining a new
	 * basis within the same space, giving a nice coordinate
	 * transform! */
	glm::vec3 origin;
	glm::mat4 view;
public:
...
int main(void)
{
	glm::mat4 rot = glm::rotate(glm::identity<glm::mat4>(), glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
